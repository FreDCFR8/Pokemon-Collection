...
- Documented the correct `pokemon` and `number` column names, Lars source filtering, null handling, invalid-row skips, Lars main collection count guard, idempotent inserts, and rollback order.
