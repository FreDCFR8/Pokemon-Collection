        ...
        return (
          ...
          >
            ...
            {selectedSetCard ? (() => {
              ...
              const { canAddWishlist, canRemoveWishlist } = getSetWishlistCapabilities({
              ...
              return (
                <CardDetailDialog
                  card={{
                    ...
                    set: { setCode: openSet.set_code, name: openSet.name, series: openSet.series, releaseDate: openSet.release_date },
